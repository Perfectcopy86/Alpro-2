...
// void merge_terurut(int n, kangminyak suplier1[], double hasil[], int m, kangminyak suplier2[], double hasil2[],kangminyak suplier3[], double hasil3[]){
// 	int i = 0;
// 	int j = 0;
...
// 			hasil3[remainder]= hasil2[j];
// 			j++, remainder++;
// 		}else{
// 			hasil3[remainder] = hasil[i];
// 			i++, remainder++;
...
// 			hasil3[remainder] = hasil[count];
// 			remainder++;
// 		}
// 	}

// 	if(j < m){
// 		for(count = j; count < m; count++){
// 			hasil3[remainder], hasil2[count];
// 			remainder++;
// 		}
// 	}
// }
